...
public class IHA_Employee_AllScenarios extends Base_Class {
	...
	IHA_EmployeeFlow IHA_EmployeeFlow;
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("IHA_Employee");
		log = new Log();
		...
		IHA_EmployeeFlow = new IHA_EmployeeFlow();
	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws Throwable {
		...
		try {
			...
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes") && TestScenario.contains("IHA")) {
				...
				case "IHA_EmployeeFlow":
					context.setAttribute("fileName", "Login");
					Login();
					IHA_EmployeeFlow.ValidateEmployeeFlow(TestScenario,GroupName, testdata, Password);
					Logout();
