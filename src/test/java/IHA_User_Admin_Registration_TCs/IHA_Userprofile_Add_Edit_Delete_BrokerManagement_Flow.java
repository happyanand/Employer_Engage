...
//Add User Profile user with BrokerManagement role.
public class IHA_Userprofile_Add_Edit_Delete_BrokerManagement_Flow extends IHA_User_Admin_Registration_AllScenarios{
	...
	public void ValidateIHA_Userprofile_Add_Edit_Delete_BrokerManagement_Flow(String TestScenario,String GroupName,String PhoneNo,
			String EmailId,String Role, String Password) throws InterruptedException, AWTException, IOException 
	{
				...
				//GroupContactUser.selectUserRole();
				...
				ExtentSuccessMessage("********User Registration Check*********");
				/////*****Register Check*****/////
				//Enter the User Name
				...
				Group_Page.Logout1();
				WaitForPageLoad();
				ExtentSuccessMessage("********History Check*********");
				/////*****History Check*****/////
				...
				//Click onn the Search Icon
				GroupContactUser.ClickOnSearchIcon();
				ExtentSuccessMessage("********Edit Check*********");
				/////*****Edit Check*****/////
				...
				ExtentSuccessMessage("********Delete Check*********");
				/////*****Delete Check*****/////
