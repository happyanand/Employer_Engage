...
public class IHA_ClientAdmin_Add_Edit_Delete_Flow extends IHA_User_Admin_Registration_AllScenarios{
	...
	public void ValidateSperidian_ClientAdmin_Add_Edit_Delete_Flow(String TestScenario,String GroupName,String PhoneNo,
			String EmailId, String Group, String Password) throws InterruptedException, AWTException, IOException 
	{
		...
		/////*****Register Check*****/////
		//Enter the User Name
		String UserName = FullName1+"_UserCA123";
