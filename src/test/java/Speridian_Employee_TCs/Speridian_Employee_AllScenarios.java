...
public class Speridian_Employee_AllScenarios extends Base_Class {
...
/////////////// About_Page/////////////////////////
	...
	Speridian_Employee_Flow Speridian_Employee_Flow;
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("Speridian_Employee");
		log = new Log();
		...
		Speridian_Employee_Flow = new Speridian_Employee_Flow();
	}
	...
	public void Login() throws InterruptedException {
		String ReferenceLogin = "Speridian";
		try {
	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws Throwable {
		...
		try {
			...
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes") && TestScenario.contains("Speridian")) {
				...
				case "Speridian_Employee_Flow":
					context.setAttribute("fileName", "Login");
					Login();
					Speridian_Employee_Flow.Speridian_Employee_flows(TestScenario,GroupName,testdata);
					Logout();
