...
public class Speridian_RC_Emp_AllScenarios extends Base_Class {
	...
	Speridian_RC_EmpFlow Speridian_RC_EmpFlow;
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("Speridian_RC_Employee");
		log = new Log();
		TestListener = new TestListener();
		screenShot = new com.Utility.ScreenShot(null);
		Base_Class = new Base_Class();
		
		/////////////// Speridian_RC_Employee ///////////////////////////

		Speridian_RC_EmpFlow = new Speridian_RC_EmpFlow();
	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws Throwable {
		...
		try {
			...
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes") && TestScenario.contains("Speridian_RC_EmpFlow")) {
				...
				//////////////////// Speridian_RC_Employee ////////////////////////
				case "Speridian_RC_EmpFlow":
					context.setAttribute("fileName", "Login");
					Login();
					Speridian_RC_EmpFlow.ValidatedRenewalCenter(TestScenario,GroupName,testdata);
					Logout();
