...
public class FBMC_RC_Admin_BA_Flow extends FBMC_RC_Admin_BA_AllScenarios
{	
	...
	public  void ValidatedRenewalCenter(String TestScenario, String GroupName,Map<Object, Object> testdata)throws InterruptedException, AWTException, IOException  {
		...
		viewCoveragePage.ClickOnPlanDropdown("Medical");
		//Select Legal Plan
		...
		String Newname= updateCoveredMembers.memberName("Vision");
