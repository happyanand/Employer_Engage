...
public class FBMC_QE_On_MedicareFlow extends FBMC_Admin_BA_AllScenarios
{
	...
	//Validate QE on Medicre
	public void ValidateQEOnMedicare(String TestScenario, String GroupName,Map<Object, Object> testdata) throws InterruptedException, AWTException, IOException 
	{		
		//Select Group
	    ...
	    Thread.sleep(5000);
	    //Click on the Medicare Dropdown and Enroll Button
	    ViewCoverage_Page.ClickOnDeclinedPlanDropdownEnroll("Medicare Advantage & Part D");
