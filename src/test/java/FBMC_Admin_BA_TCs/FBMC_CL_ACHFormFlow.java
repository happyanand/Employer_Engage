...
public class FBMC_CL_ACHFormFlow extends FBMC_Admin_BA_AllScenarios {
	...
	public void ValidateCLACHForm(String TestScenario, String GroupName, Map<Object, Object> testdata)
		...
		accountsummary_page.clickACHForm();
		//Click on OK button
		accountsummary_page.clickOKbutton();
		//Get the text for ACH 
		String LetterType = accountsummary_page.getACHLetterType();
