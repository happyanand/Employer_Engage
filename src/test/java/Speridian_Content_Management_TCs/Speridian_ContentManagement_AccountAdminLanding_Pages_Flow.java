...
public class Speridian_ContentManagement_AccountAdminLanding_Pages_Flow extends Speridian_Content_Management_AllScenarios {
	...
	//ContentManagement-Pages with Page type as AccountAdminLanding
	public void ValidateSperidian_ContentManagement_AccountAdminLanding_Pages_Flow(String testScenario,Map<Object, Object> testdata) throws InterruptedException, AWTException, IOException {
...
//		pages.Addurl(testdata.get("URL").toString());
		...
		ExtentSuccessMessage("******************Adding Page Verification*****End************");
		ExtentSuccessMessage("******************Support Login Page Verification***************");
		///////// Verification of Pages ///////// 	
		//Login with Support User
		Group_Page.supportUserLogin();
		//Search with Advance
		Group_Page.Speridianadvancesearch(testdata);
		...
		//Logout User
		Group_Page.Logout1();
		ExtentSuccessMessage("******************Login Admin again and UnPublish Verification***************");
		//Click on ContentManagementTab
		Home_Page.CheckContentManagementTabDispaly();
		//Validate Pages
		contentManagementPage.validatePages();
		...
		ExtentSuccessMessage("******************CopyUnPublish Verification***************");
		//Click on Copy
		contentManagementPage.ClickOncopy();
		//Click on Preview
		ExtentSuccessMessage("******************Preview Verification***************");
		contentManagementPage.ClickOnPreview();
		//Click on Delete
		ExtentSuccessMessage("******************Delete Verification***************");
		contentManagementPage.ClickOnDelete();
		///////// Export ///////// 
		//Click on Export Icon
		ExtentSuccessMessage("******************Export Verification***************");
