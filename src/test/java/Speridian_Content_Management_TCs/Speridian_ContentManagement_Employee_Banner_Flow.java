...
public class Speridian_ContentManagement_Employee_Banner_Flow extends Speridian_Content_Management_AllScenarios {
	...
	public void ValidateSperidian_ContentManagement_Employee_Banner_Flow(String testScenario,Map<Object, Object> testdata) throws InterruptedException, AWTException, IOException {
		...
		if(testdata.get("Account")!= "")
			bannerPage.selectDropdownValues(testdata.get("Account").toString(), "Select Account");
		else if(testdata.get("BusinessSegment")!= "")
			bannerPage.selectDropdownValues(testdata.get("BusinessSegment").toString(), "Business Segment");
		//Select Role
