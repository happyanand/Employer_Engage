...
public class FBMC_Florida_ChangeRate_turns_70or75 extends FBMC_Business_Automation_Rules_AllScenarios{
	...
	public void ValidateFBMC_Florida_ChangeRate_turns_70or75(String TestScenario, String GroupName, Map<Object, Object> testdata)
		...
		// Select Plans
		List<Map<String, String>> selectedPlanDetails = enrollmentPage.selecttwoPlans(false, testdata.get("planName").toString(),testdata.get("planName2").toString());
		...
		ViewCoverage_Page.ClickOnPlanDropdown(testdata.get("planName2").toString());
