...
public class IHA_TerminateEmployeeFlow extends IHA_Admin_BA_AllScenarios {
...
//		manageCoverage_Page.searchEmployee(ssn);
		...
		enrollmentSummaryPage.closeEnrollmentSummary();
		viewCoveragePage.verifyTerminationDateToAllPlans(testdata.get("TerminationDate").toString());
