...
public class FBMC_RC_Emp_AllScenarios extends Base_Class {
	...
	/////////////// About_Page/////////////////////////
		...
		FBMC_RC_EmpFlow FBMC_RC_EmpFlow;	
		...
		public void reference() {
			ExcelReader = new com.Utility.ExcelReader("FBMC_RC_Employee");
			log = new Log();
			...
			FBMC_RC_EmpFlow = new FBMC_RC_EmpFlow();
		...
		public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws Throwable {
			...
			try {
				...
				if (testdata.get("Run").toString().equalsIgnoreCase("Yes") && TestScenario.contains("FBMC_RC_Emp")) {
					...
					case "FBMC_RC_EmpFlow":
						context.setAttribute("fileName", "Login");
						Login();
						FBMC_RC_EmpFlow.ValidatedRenewalCenterEmp(TestScenario,GroupName,testdata,EmailId,Password,SecurityQuestion1,SecurityAnswer1,SecurityQuestion2,SecurityAnswer2,SecurityQuestion3,SecurityAnswer3);
						Logout();
