...
public class Speridian_EnrollAndMaintainenceWithRateEditPlanFlow extends Speridian_Admin_BA_AllScenarios {
	...
	//Validate Enroll And Maintainence With Rate Edit Plan
	public void ValidateEnrollAndMaintainenceWithRateEditPlan(String TestScenario, String GroupName,Map<Object, Object> testdata)throws InterruptedException, AWTException {
		...
		ViewCoverage_Page.ClickonFsaDropdowns();
		...
		//enrollAndMaintainance.verifyChangedRate(testdata.get("EditedMonthlyAmount").toString(), enrollAndMaintainance.monthlyrateChanged());
