...
public class FBMC_BAAdmin_RegistrationFlow  extends FBMC_User_Admin_Registration_AllScenarios {
	...
	//	UserAdministration_Page UA_Page = new UserAdministration_Page();
	EmployeeAdministration_Page EmployeeAdministration_Page =new EmployeeAdministration_Page();

	public void ValidateFBMC_BAAdmin_RegistrationFlow(String TestScenario,String GroupName,String PhoneNo,String EmailId, String Group, String Group2,String Password,String SecurityQuestion1,String SecurityAnswer1,String SecurityQuestion2,String SecurityAnswer2,String SecurityQuestion3,String SecurityAnswer3, String EmploySearch) throws InterruptedException, AWTException, IOException {
