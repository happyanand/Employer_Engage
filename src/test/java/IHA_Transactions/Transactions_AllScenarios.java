...
public class Transactions_AllScenarios extends Base_Class {
	...
	IHA_Transactions_Flow IHA_Transactions_Flow;
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("IHA_Transactions");
		log = new Log();
		...
		IHA_Transactions_Flow = new IHA_Transactions_Flow();
	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws Throwable {
		...
		try {
			...
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes") && TestScenario.contains("IHA")) {
				...
				//////////////////// Speridian_Employee_Page////////////////////////
				case "IHA_Transactions_Flow":
					context.setAttribute("fileName", "Login");
					Login();
					IHA_Transactions_Flow.ValidateIHA_Transactions_Flow(TestScenario);
					Logout();
