...
public class IHA_RC_Admin_BA_AllScenarios extends Base_Class {
	...
	/////////////// About_Page/////////////////////////
		...
		IHA_RC_Admin_BA_Flow IHA_RC_Admin_BA_Flow;	
		...
		public void reference() {
			ExcelReader = new com.Utility.ExcelReader("IHA_RC_Admin");
			log = new Log();
			...
			IHA_RC_Admin_BA_Flow = new IHA_RC_Admin_BA_Flow();
		...
		public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws Throwable {
			...
			try {
				...
				if (testdata.get("Run").toString().equalsIgnoreCase("Yes") && TestScenario.contains("IHA_RC_Admin")) {
					...
					case "IHA_RC_Admin_BA_Flow":
						context.setAttribute("fileName", "Login");
						Login();
						IHA_RC_Admin_BA_Flow.ValidateRenewalCenter(TestScenario,GroupName,testdata);
						Logout();
