...
public class FBMC_BillingAndPayments_AllScenarios extends Base_Class {
	...
	FBMC_Billpay_NewEmployee FBMC_Billpay_NewEmployee;

	BillPay_PensionAuthority_VendorACH_Reconciliation BillPay_PensionAuthority_VendorACH_Reconciliation;
	...
	public static String reportFileName = "Automation_Report_"+formatter.format(date)+".html";
	public static String reportFilepath = System.getProperty("user.dir") + "\\TestReport\\";
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("FBMC_BillingAndPayments");
		log = new Log();
		...
		FBMC_Billpay_NewEmployee = new FBMC_Billpay_NewEmployee();
		BillPay_PensionAuthority_VendorACH_Reconciliation = new BillPay_PensionAuthority_VendorACH_Reconciliation();
	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws Throwable {
		...
		try {
			...
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes") && TestScenario.contains("FBMC")) {
				...
				case "FBMC_Billpay_NewEmployee":
					context.setAttribute("fileName", "Login");
					Login();
					FBMC_Billpay_NewEmployee.ValidateFBMC_Billpay_NewEmployee(TestScenario, GroupName, testdata);
					Logout();
					context.setAttribute("fileName", "Logout");
					break;

					
				case "FBMCBillPay_PensionAuthority_VendorACH_Reconciliation":
					context.setAttribute("fileName", "Login");
					Login();
					BillPay_PensionAuthority_VendorACH_Reconciliation.ValidateBillPay_PensionAuthority_VendorACH_Reconciliation(TestScenario, testdata);
					Logout();
					context.setAttribute("fileName", "Logout");
					break;	
