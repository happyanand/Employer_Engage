...
public class IHA_ContentManagement_Employee_Banner_Flow extends IHA_ContentManagement_AllScenarios {
	...
	public void ValidateIHA_ContentManagement_Employee_Banner_Flow(String testScenario,Map<Object, Object> testdata) throws InterruptedException, AWTException, IOException {		
		...
		//Select Role
		bannerPage.selectrole(testdata.get("ExternalRole").toString());
		//Select Page 
