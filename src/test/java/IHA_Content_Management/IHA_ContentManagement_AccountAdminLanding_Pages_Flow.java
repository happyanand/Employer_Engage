...
public class IHA_ContentManagement_AccountAdminLanding_Pages_Flow extends IHA_ContentManagement_AllScenarios{
	...
	public void ValidateIHA_ContentManagement_AccountAdminLanding_Pages_Flow(String testScenario,Map<Object, Object> testdata) throws InterruptedException, AWTException, IOException {

		//Click on ContentManagementT
		...
		contentManagementPage.search_Name(pages.name);
		//Click on Unpublish
		contentManagementPage.ClickOnUnpublish();  //Since publish took lot of time hence unbublish scripts getting failed 
		//Click on Yes
